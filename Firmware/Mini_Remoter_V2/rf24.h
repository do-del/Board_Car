...
#define MOSI_HIGH() (PORTB |= 0x08)
#define MOSI_LOW() (PORTB &= ~0x08)
//#define MISO_HIGH() (PORTB |= 0x10)
//#define MISO_LOW() (PORTB &= ~0x10)
#define MISO_VALUE() ((PINB &= 0x10)>>4)
//#define MISO_VALUE() (PINB & 0x10)
#define SCK_HIGH() (PORTB |= 0x20)
#define SCK_LOW() (PORTB &= ~0x20)
#define CSN_HIGH() (PORTB |= 0x02)
#define CSN_LOW() (PORTB &= ~0x02)
#define CE_HIGH() (PORTB |= 0x01) //CE高电平，芯片由Standby模式进入到Idle-TX或RX模式
#define CE_LOW() (PORTB &= ~0x01) //CE低电平，芯片返回Standby模式
#define IRQ_VALUE() (PINB & 0x04)
